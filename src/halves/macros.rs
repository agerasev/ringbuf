macro_rules! impl_prod_traits {
    ($Prod:ident) => {
        #[cfg(feature = "std")]
        impl<R: $crate::rb::RbRef> std::io::Write for $Prod<R>
        where
        ...
        impl<R: $crate::rb::RbRef> core::fmt::Write for $Prod<R>
        where
            R::Target: $crate::traits::Producer<Item = u8>,
        {
...
macro_rules! impl_cons_traits {
    ($Cons:ident) => {
        impl<R: $crate::rb::RbRef> IntoIterator for $Cons<R>
        where
        ...
        #[cfg(feature = "std")]
        impl<R: $crate::rb::RbRef> std::io::Read for $Cons<R>
        where
